...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default="Robust04Corpus", help="data path")
    parser.add_argument('--train_path', type=str, default="split1_train_BM25_0.9_0.5_RM3_47_9_0.3.txt",
                        help='training file generated by Anserini')
    parser.add_argument('--dev_path', type=str, default="split1_dev_BM25_0.9_0.5_RM3_47_9_0.3.txt",
                        help='training file generated by Anserini')
    parser.add_argument('--test_path', type=str, default="split1_test_BM25_0.9_0.5_RM3_47_9_0.3.txt",
                        help='training file generated by Anserini')
    ...
    srcdir = args.data_path
    dstdir = args.output_path
    
    infiles = [ os.path.join(srcdir, args.train_path), os.path.join(srcdir, args.dev_path), os.path.join(srcdir, args.test_path)]
